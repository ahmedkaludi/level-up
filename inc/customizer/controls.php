...
class Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/assets/admin/js/customizer-range-value-control.js', array( 'jquery' ), rand(), true );

		wp_enqueue_style( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/assets/admin/css/customizer-range-value-control.css', array(), rand() );
	}
...
class Customizer_Toggle_Control extends WP_Customize_Control {
	 ...
	 */
	public function enqueue() {
		wp_enqueue_script( 'customizer-toggle-control', get_template_directory_uri() . '/inc/customizer/assets/admin/js/customizer-toggle-control.js', array( 'jquery' ), rand(), true );
		wp_enqueue_style( 'pure-css-toggle-buttons', get_template_directory_uri() . '/inc/customizer/assets/admin/css/customizer-togle-buttons.css', array(), rand() );
...
class Separator_Custom_control extends WP_Customize_Control{
	...
	public function render_content(){
		?>
		<label>
			<h4 class="customize-control-title levelup-customize-subtitle"><?php echo esc_html( $this->label ); ?></h4>
			<?php if ( ! empty( $this->description ) ) : ?>
			<span class="description customize-control-description"><?php echo $this->description; ?></span>
			<?php endif; ?>
		</label>
...
class Customizer_Select2_Multiselect extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'select2-min-js', get_template_directory_uri() . '/inc/customizer/assets/admin/js/select2.min.js', array( 'jquery' ), rand(), true );
		wp_enqueue_style( 'select2-css', get_template_directory_uri() . '/inc/customizer/assets/admin/css/select2.min.css', array(), rand() );
		wp_enqueue_style( 'customizer-select2-control', get_template_directory_uri() . '/inc/customizer/assets/admin/css/customizer-select2-control.css', array(), rand() );
	}
